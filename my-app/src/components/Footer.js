    ...
    <div className="container text-center text-md-start mt-5">
      ...
      <div className="row mt-3">
        ...
        <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <p>
            Here you can connect with us using all social media
            For all client complaints please do not hesitate to contact us
           </p>
        </div>
        ...
        <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" className="text-reset">Milk and cheese</a>
          </p>
          <p>
            <a href="#!" className="text-reset">Fruits</a>
          </p>
          <p>
            <a href="#!" className="text-reset">Meat</a>
          </p>
          <p>
